  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ textAlign: 'left', mr: "160px" }}>
        ...
        <p style={{ margin: "0px 0px 0px 40px" }}>Set up your slides here: <a href="/slides"><MonitorHeart sx={{ position: "relative", top: "10px", fontSize: "32px" }}/></a></p>
        <p style={{ margin: "0px 0px 0px 40px" }}>Configure connections here: <a href="/connections"><Settings sx={{ position: "relative", top: "10px", fontSize: "32px" }}/></a></p>
